        ...
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between">
                ...
                <div class="flex items-center cursor-pointer" wire:click="completed">
                    ...
                    <p class="ml-2 text-sm">Marcar esta unidad ocmo culminada</p>
    
                </div>

                @if ($current->resource)
                    <div class="flex items-center mt-4 text-gray-600 cursor-pointer" wire:click="download">
                        <i class="text-lg text-gray-600 fas fa-download"></i>
            ...
            <div class="mt-2 card">
                <div class="flex font-bold text-gray-500 card-body">
                    ...
                    @if ($this->next)
                        <a wire:click="changeLesson({{$this->next}})" class="ml-auto cursor-pointer ">Sigueinte tema</a>
                    @endif
                </div>
            </div>
