<x-app-layout>
    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                @isset($course->image)
                    <img class="w-full h-60 object-cover" src="{{Storage::url($course->image->url)}}" alt="">
                @else
                    <img class="w-full h-60 object-cover" src="https://static.fundacion-affinity.org/cdn/farfuture/PVbbIC-0M9y4fPbbCsdvAD8bcjjtbFc0NSP3lRwlWcE/mtime:1643275542/sites/default/files/los-10-sonidos-principales-del-perro.jpg" alt="">
                @endisset
            </figure>
            ...
            <section class="mb-12">
                ...
                @forelse ($course->sections as $section)
                    <article class="mb-4 shadow" 
                        ...
                        <div class="bd-white py-2 px-4" x-show="open">
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.courses.approved', $course)}}" class="mt-4" method="POST">
                        @csrf
                        <button class="btn btn-danger w-full" type="submit">Aprovar curso</button>
                    </form>
